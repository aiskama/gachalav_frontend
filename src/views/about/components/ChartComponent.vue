    ...
    return {
      chartData: {
        ...
        datasets: [
          ...
          {
            label: this.data.map((item) => item.title)[2],
            backgroundColor: this.data.map((item) => item.color)[2],
            borderColor: this.data.map((item) => item.color)[2],
            tension: 0.2,
            data: this.data.map((item) =>
              item.values
                .flat()
          ...
          {
            label: this.data.map((item) => item.title)[3],
            backgroundColor: this.data.map((item) => item.color)[3],
            borderColor: this.data.map((item) => item.color)[3],
            tension: 0.2,
            data: this.data.map((item) =>
              item.values
                .flat()
